'''
Exemplo de sobreescrita de atributos onde a classe filha (CadFunc) substitui o valor do atributo
definido na classe mãe (DadosCad).
'''
...
if __name__ == '__main__':
    ...
    exibe_dados(fulana)
    beltrana = CadFunc('Beltrana',18, 'F', None)
